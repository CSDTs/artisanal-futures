...
const ArtisanCard: FC<ICardProps> = ({ data, slug }) => {
	return (
		<div className="w-full p-4 bg-slate-50 shadow rounded">
			<img src={data?.profile_image_url} alt="" className="aspect-square object-cover" />

			<div className="flex w-full items-center justify-between">
				<div>
					<h3 className="font-semibold text-xl">{data?.full_name}</h3>
