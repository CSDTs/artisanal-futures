	...
	return (
		<PageContainer>
			<article className="prose lg:prose-xl">
				...
				<p>
					When registering on our site, you may be asked to enter your name and e-mail address. You may, however, visit
					our site without registering. Your e-mail address will be verified by an email containing a unique link. If
					that link is visited, we know that you control the e-mail address.
				</p>
				<p>
				...
				<h4 id="what-do-we-use-your-information-for">What do we use your information for?</h4>
				...
				<ul>
					...
					<li>
						To improve our site — we continually strive to improve our site offerings based on the information and
					...
					<li>
						...
						that you request about changes to topics or in response to your user name, respond to inquiries, and/or
				...
				<h4 id="what-is-your-data-retention-policy">What is your data retention policy?</h4>
				...
				<p>
					...
					contract with third-party service providers to assist us in better understanding our site visitors. These
					service providers are not permitted to use the information collected on our behalf except to help us conduct
				...
				<p>
					...
					server is in the USA, and you are under the age of 13, per the requirements of COPPA (
