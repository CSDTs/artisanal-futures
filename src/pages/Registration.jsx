...
import { Gateway, Inquire } from "../features/Registration";
import Logout from "../features/Registration/components/Logout";
...
const SERVICE_ID = "artisanal_futures";
const TEMPLATE_ID = "template_owjrard";
const USER_ID = "Km4HuaBvcwCIWgEzZ";

export default function Registration() {
	const { hasCopied, onCopy } = useClipboard("artisanalfutures@gmail.com");
	...
	return (
		<Container maxW={"6xl"} mt={6}>
			<Heading mb={6}>Become an Artisan</Heading>
			<Text mt={1} display="block" fontSize="lg" lineHeight="normal" fontWeight="semibold" marginBottom={"2rem"}>
				Interested in becoming one of our featured artisans? Let us know about you!
			</Text>
			...
			<Flex
				...
				id="contact">
				{!currentUser && !hasCode && <Inquire setHasCode={setHasCode} />}
				{!currentUser && hasCode && <Gateway />}
				{currentUser && <Logout />}
			</Flex>
		</Container>
	);
