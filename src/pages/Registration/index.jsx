import { Button, createIcon, Flex, Heading, Icon, Input, Stack, Text, useColorModeValue } from "@chakra-ui/react";
	...
	return (
		<Flex minH={"100vh"} align={"center"} justify={"center"} py={12} bg={useColorModeValue("gray.50", "gray.800")}>
			...
			>
				...
				<Text color={"gray.500"}>*Don't worry, we will not spam you 😊</Text>
			</Stack>
		</Flex>
	);
}
