...
const AttributeField: FC<IProps> = ({ attributes, selectedAttributes, filteredAttributes, handleSelect }) => {
	return (
		<fieldset className="my-6">
			<legend className="text-sm font-semibold leading-6 text-gray-900">Store Attributes</legend>
