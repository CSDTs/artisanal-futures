...
const hourlyPieChart: FC<IProps> = ({ monthlyHourly, materialHourly, laborHourly, hours, isValid, colors }) => {
	...
	return (
		<div className="flex justify-center mx-auto lg:w-6/12">
			<PieChart data={priceData} lineWidth={15} paddingAngle={5} labelPosition={60} />
		</div>
	);
};
